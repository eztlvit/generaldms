...
<body>
	<div class="sidebar" id="sidebar">
		...
		<ul class="nav nav-list">
			...
			<li><a href="#" class="dropdown-toggle"> <i
					class="icon-file-alt"></i> <span class="menu-text"> 知识管理 <span
						class="badge badge-primary ">${fn:length(kmCatalogueLst)}</span>
				</span> <b class="arrow icon-angle-down"></b>
			</a>

				<ul class="submenu">
					<c:forEach items="${kmCatalogueLst}" var="c" varStatus="status">
						<li><a href="/generaldms/getKnowledgeData?cId=${c.id}&cName=${c.label}"> <i class="icon-double-angle-right"></i>
							${c.label}
						</a></li>
					</c:forEach>
				</ul>
